...
public enum ContainerStatus {
	...
	IN_TRANSIT_TO_LOADLOCK_FROM_HOTEL("in_transit_to_loadlock_from_hotel"),
	IN_TRANSIT_TO_LOADLOCK_FROM_LOCAL_STORAGE("in_transit_to_loadlock_from_local_storage"),
