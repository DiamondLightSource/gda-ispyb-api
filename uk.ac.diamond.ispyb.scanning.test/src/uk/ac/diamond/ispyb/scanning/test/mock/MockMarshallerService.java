...
import uk.ac.diamond.ispyb.scanning.test.mock.MockMarshallerServiceClassRegistry.ClassRegistryDuplicateIdException;
 ...
 */
public class MockMarshallerService implements IMarshallerService {
	 ...
	 */
	public MockMarshallerService(IClassRegistry... extra_registries) {
	 ...
	 * @param marshallers
	 */
	public MockMarshallerService(IMarshaller... marshallers) {
	 ...
	 * @param marshallers
	 */
	public MockMarshallerService(List<IClassRegistry> extra_registries, List<IMarshaller> marshallers) {
		platformIsRunning = false;
	...
	private ObjectMapper createRegisteredClassMapper() throws InstantiationException, IllegalAccessException, ClassRegistryDuplicateIdException, Exception {
	...
	private final ObjectMapper createJacksonMapper() throws InstantiationException, IllegalAccessException, Exception {
	...
	private void createModuleExtensions(SimpleModule module) throws Exception {
	 ...
	 */
	private TypeResolverBuilder<?> createRegisteredTypeIdResolver() throws ClassRegistryDuplicateIdException, Exception {
		MockMarshallerServiceClassRegistry registry = new MockMarshallerServiceClassRegistry(extra_registries);
	...
	private class RegisteredTypeResolverBuilder extends DefaultTypeResolverBuilder {
		...
		private MockMarshallerServiceClassRegistry registry;

		public RegisteredTypeResolverBuilder(MockMarshallerServiceClassRegistry registry) {
			this(null, registry);
		}

		public RegisteredTypeResolverBuilder(DefaultTyping typing, MockMarshallerServiceClassRegistry registry) {
			super(typing);
		...
		boolean forSer, boolean forDeser) {
			return new MockRegisteredClassIdResolver(baseType, config.getTypeFactory(), registry);
		}
