...
public class CompositeTest extends ExperimentServiceTest {
	...
	public void testTwoUpdatesComposite() throws Exception {
		Id id = service.composite(prepare2Updates(), true);
		assertEquals(2, id.size()); // Two Id.NONE
	}

	@Test
	public void testTwoUpdatesUpdate() throws Exception {
		Id id = service.update(prepare2Updates(), true);
		assertEquals(2, id.size()); // Two Id.NONE
	}
	...
	private CompositeBean prepare2Updates() {
	...
	public void testTwoUpdatesOneInsertComposite() throws Exception {
		Id id = service.composite(prepare2Updates1Insert(), true); // There are no inserts!
		assertEquals(3, id.size()); // Two Id.NONE, One insert id
	}
	
	@Test
	public void testTwoUpdatesOneInsertUpdate() throws Exception {
		Id id = service.update(prepare2Updates1Insert(), true); // There are no inserts!
		assertEquals(2, id.size()); // Two Id.NONE
	}
	
	@Test
	public void testTwoUpdatesOneInsertInsert() throws Exception {
		Id id = service.insert(prepare2Updates1Insert(), true); // There are no inserts!
	...
	public void testFourUpsertsComposite() throws Exception {
		Id id = service.composite(prepareFourUpserts(), true); // There are no inserts!
		assertEquals(2, id.size()); // Group is repeated so gets overwritten
	}

	@Test
	public void testFourUpsertsUpsert() throws Exception {
		Id id = service.upsert(prepareFourUpserts(), true); // There are no inserts!
		assertEquals(2, id.size()); // Group is repeated so gets overwritten
	}
